...
add wave -noupdate /axi_tb_top/axi_if_inst/awlock
add wave -noupdate /axi_tb_top/axi_if_inst/awcache
add wave -noupdate /axi_tb_top/axi_if_inst/awprot
...
WaveRestoreCursors {{Cursor 1} {263107 ps} 0}
...
update
WaveRestoreZoom {197142 ps} {315872 ps}
